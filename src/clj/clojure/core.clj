...
;if restore? is false (default), bindings will persist after returned
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;; futures (needs proxy);;;;;;;;;;;;;;;;;;
(def ^:private __futjure-CLJ-2619 (= "true" (System/getProperty "futjure.CLJ-2619")))
(defn future-call 
  ...
  {:added "1.1"
   :static true}
  [f]
  (let [f (binding-conveyor-fn f __futjure-CLJ-2619)
